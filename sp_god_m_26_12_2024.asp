...
'".shap FROM "&file0&" LEFT JOIN "&file1&" ON "&file0&".bok="&file1&".bok;" 
...
poisk=" where month(rzzz)=1 "   ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_1",poisk) 'табл из бок(будет во всех других табл) и count(шапка обычно AT_0)+ поиск  

poisk=" where month(rzzz)=2" ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_2",poisk)
                      
poisk=" where month(rzzz)=3 "  ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_3",poisk) 

poisk=" where month(rzzz)=4 "   ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_4",poisk) 'табл из бок(будет во всех других табл) и count(шапка обычно AT_0)+ поиск  

poisk=" where month(rzzz)=5" ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_5",poisk)
                      
poisk=" where month(rzzz)=6 "  ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_6",poisk) 

poisk=" where month(rzzz)=7 "   ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_7",poisk) 'табл из бок(будет во всех других табл) и count(шапка обычно AT_0)+ поиск  

poisk=" where month(rzzz)=8" ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_8",poisk)
                      
poisk=" where month(rzzz)=9 "  ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_9",poisk) 

poisk=" where month(rzzz)=10 "   ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_10",poisk) 'табл из бок(будет во всех других табл) и count(шапка обычно AT_0)+ поиск  

poisk=" where month(rzzz)=11 " ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_11",poisk)
                      
poisk=" where month(rzzz)=12 "  ' модно вставлять поиск допустим "where r5=1"
call sp_count("rzzz","AT_0","atoc_sp_1","GM_12",poisk) 
