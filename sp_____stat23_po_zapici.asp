...
<BODY bgcolor=Tan>
2023  год по месяцам и по дате записи
<BR>
...
sub STAT_1    ' заполняет массив кол-ва МЕСЯЦЕВ по ДНЯМ--------------------------
   ZAPROS = "Select * From "&Name_Zad & " where AT_V_D >='20230101';"
...
sub PRINT(Z) ' выводит на экран таблицу----------------
    if Z=0 then Z=""
    Z="<A href='\PREKR_2020-09-16/ATOC\all-poisk.asp?T=2&P1=" & D & "&P2=" & M & "'>&nbsp;<FONT size=+1>" & ZNA & "</FONT>&nbsp;</A>"
    Response.Write "<TD>" & Z
end sub
