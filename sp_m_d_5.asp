...
'   ZAPR =ZAPR+"shap8 int,shap9 int,shap10 int,shap11 int,shap12 int);"  'создаем табл
   ...
   if db.Errors.Count > 0 then
    ...
    ZAPR = "insert into "&file_out&"(bok) SELECT bok FROM "&file1&" UNION ALL SELECT bok FROM "&file2&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file2&" UNION ALL SELECT bok FROM "&file3&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file3&" UNION ALL SELECT bok FROM "&file4&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file4&" UNION ALL SELECT bok FROM "&file5&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file5&" UNION ALL SELECT bok FROM "&file6&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file6&" UNION ALL SELECT bok FROM "&file7&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file7&" UNION ALL SELECT bok FROM "&file8&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file8&" UNION ALL SELECT bok FROM "&file9&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file9&" UNION ALL SELECT bok FROM "&file10&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file10&" UNION ALL SELECT bok FROM "&file11&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file11&" UNION ALL SELECT bok FROM "&file12&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file12&" UNION ALL SELECT bok FROM "&file13&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file13&" UNION ALL SELECT bok FROM "&file14&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file14&" UNION ALL SELECT bok FROM "&file15&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file15&" UNION ALL SELECT bok FROM "&file16&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file16&" UNION ALL SELECT bok FROM "&file17&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file17&" UNION ALL SELECT bok FROM "&file18&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file18&" UNION ALL SELECT bok FROM "&file19&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file19&" UNION ALL SELECT bok FROM "&file20&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file20&" UNION ALL SELECT bok FROM "&file21&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file21&" UNION ALL SELECT bok FROM "&file22&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file22&" UNION ALL SELECT bok FROM "&file23&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file23&" UNION ALL SELECT bok FROM "&file24&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file24&" UNION ALL SELECT bok FROM "&file25&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file25&" UNION ALL SELECT bok FROM "&file26&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file26&" UNION ALL SELECT bok FROM "&file27&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file27&" UNION ALL SELECT bok FROM "&file28&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file28&" UNION ALL SELECT bok FROM "&file29&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file29&" UNION ALL SELECT bok FROM "&file30&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file30&" UNION ALL SELECT bok FROM "&file31&" Group by bok Order by bok" 
    ZAPR =ZAPR+" SELECT bok FROM "&file31&" Group by bok Order by bok;"
